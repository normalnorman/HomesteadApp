...
/**
* @see APHLogger#feedback:placeholder:
*/
...
/**
* Function which sends feedback to Apphance. It is used by feedback modal.
* @param feedback Text which you want send to Apphance.
*/
