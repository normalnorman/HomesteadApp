...
/**
 ...
 The specialized class allows the developer to define a “schema” for these specialized objects by defining properties with different types.  These properties may be manipulated directly and the specialization support will handle mapping these variables into the underlying MBaaS object. For example, a specialization class might declare a property of type float with a name of “price”.   The developer can then refer to “object.price”.
...
/** Registers the class (the receiver) with the MBaaS as a specialized class */
